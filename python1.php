...
<div class="col-lg-3" >
            ...
            ?>
              ...
              <a href="python1?slug=<?php echo $slug;?>" class="font-weight-bold list-group-item list-group-item-action" style="color: white;background-color: #85FFBD;background-image: linear-gradient(45deg, #009e49 0%, #c1bb00 100%);"><?php echo $title; ?></a>
            
            <?php                  
                }else{
                ?>

            <a href="python1?slug=<?php echo $slug;?>" class="text-dark list-group-item list-group-item-action" style="background-color: #85FFBD;background-image: linear-gradient(45deg, #85FFBD 0%, #FFFB7D 100%);"><?php echo $title; ?></a>
