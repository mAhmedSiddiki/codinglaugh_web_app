   ...
   <br> <div class="row m-2">
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100 text-center m-1" style="box-shadow: 0px 0px 10px 4px black;">
          ...
          <a href="python?slug=<?php echo $slug;?>"><img class="card-img-top" src="img/python/video_playlist/<?php echo $img_file;?>" alt="video courses photo"></a>
          <div class="card-body">
          ...
          <center><a href="python?slug=<?php echo $slug;?>"><button style="color: white; background-color: #ce004c;background-image: linear-gradient(19deg, #ce004c 0%, #8203c4 100%);" class="btn btn-sm" name="savechange" type="submit">Open Course</button></a></center>
