    ...
    <div class="row m-2">
      ...
      <div class="col-lg-4 mb-3">
        <div class="card h-100 text-center m-1" style="box-shadow: 0px 0px 10px 4px black;">
          ...
          <a href="python?slug=<?php echo $slug;?>"><img class="card-img-top" src="img/python/video_playlist/<?php echo $img_file;?>" alt="Video Course Photos"></a>
          <div class="card-body">
            <a href="python?slug=<?php echo $slug;?>"><h5 style="color: #007b5e" class="card-title"><?php echo $title;?></h5></a>
            <p align="justify" style="font-size:14px;" class="card-text text-dark"><?php echo substr("$content",0,100)."..."; ?></p>
          </div>
          <center><a href="python?slug=<?php echo $slug;?>"><button style="color: white; background-color: #ce004c;background-image: linear-gradient(19deg, #ce004c 0%, #8203c4 100%);" class="btn btn-sm" name="savechange" type="submit">Open Course</button></center></a>
    ...
    <div class="row m-2">
      ...
      <div class="col-lg-4 mb-3">
        <div class="card h-100 text-center m-1" style="box-shadow: 0px 0px 10px 4px black;">
          ...
          <a href="viewblog?slug=<?php echo $slug;?>"><img class="card-img-top" src="img/blog/<?php echo $img_file;?>" alt="blog photos"></a>
          <div class="card-body">
            <a href="viewblog?slug=<?php echo $slug;?>"><h5 style="color: #007b5e;" class="card-title"><?php echo $title;?></h5></a>
            <p align="justify" style="font-size:14px;" class="card-text  text-dark"><?php echo substr("$content",0,100)."..."; ?></p>
          </div>
          <center><a href="viewblog?slug=<?php echo $slug;?>"><button style="color: white; background-color: #ce004c;background-image: linear-gradient(19deg, #ce004c 0%, #8203c4 100%);" class="btn btn-sm" name="savechange" type="submit">Read More</button></a></center>
          <div class="card-footer">
            <small>Created By: <a target="_blank" href="marjuk"><?php echo $madeby; ?></a></small>
          </div>
        </div>
